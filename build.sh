...
# Forcer aussi les options SuSFS critiques
...
grep -E "CONFIG_KSU=|CONFIG_KSU_MANUAL_HOOK=|CONFIG_KSU_SUSFS=|CONFIG_KSU_SUSFS_SUS_MOUNT=|CONFIG_KSU_SUSFS_SPOOF_CMDLINE" out/.config
echo ""
