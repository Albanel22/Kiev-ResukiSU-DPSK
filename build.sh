#!/bin/bash
set -e
echo "=== Début du build ReSukiSU + SusFS 2.3.0 (cyberc3dr) pour kiev (SM8250) - Version Finale ==="
df -h
...
# 3. CORRECTION AUTOMATIQUE DES REJETS CONNUS (Spécifique au fork Albanel22)
